...
//========================================================================================================
      "         vec3 tang                  =  tanA * vec3(normal.z*2.86, normal.y*3.41, normal.x*shininess) + sinA * vec3(normal.x*attenuation, normal.y*3.41, normal.z*2.86);  \n"  //!var         renderMonkeyish_H_ATTENUATION    =  1.057;var         renderMonkeyish_H_SHININESS    =  205.001;var         renderMonkeyish_H_NOISE_SCALE      =  -0.0034;
...
//========================================================================================================
      ...
      "         float specular             =  pow((cs * cl + sn * sl), 209.254)* NdotL1;                                             \n" 
