      ...
      "            highp vec4    color    = vec4(0.7, 0.2, 0.6, 1.0);                                                    \n"          
      "            highp vec4    gloss    = vec4(2.4, 0.4, 2.2, 1.0);                                                    \n" 
