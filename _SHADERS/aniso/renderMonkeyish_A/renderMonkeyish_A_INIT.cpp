      ...
      "            highp vec4    gloss      = vec4(0.772549*2.0, 0.588109*2.0, 0.401132*2.0, 1.0);                                   \n"     
      "            highp vec3    normal;                                                                                 \n"                       
...
//=======================================================================================================
      ...
      "   vec3 tang1 =  sinA * vec3(normalFrag.x, normalFrag.x, normalFrag.x) ;                                          \n" //!var         renderMonkeyish_B_ATTENUATION    =  0.847001;var         renderMonkeyish_B_SHININESS    =  174.998;var         renderMonkeyish_B_NOISE_SCALE      =  -0.0034;
      "   vec3 tang2 =  sinA * vec3(normalFrag.z, normalFrag.y, normalFrag.z) ;                                          \n"    //!


      "    float cs  = -dot(viewVec, tang1);                                                                             \n" 
      "    float cs2 = -dot(viewVec, tang2);                                                                             \n"       
     
      "    float sn  = sqrt(1.0 - cs * cs)* NdotL1  ;                                                                   \n" 
      
      "    float cl  =  dot(oglLightDir.xyz, tang1);                                                                     \n" 
      "    float cl2 =  dot(oglLightDir.xyz, tang2);                                                                     \n"       
      
      "    float sl  = sqrt(1.0 - cl * cl)* NdotL1  ;                                                                   \n" 
      
      "    float specular = pow( clamp( ( cs *cl + sn * sl), 0.0, 1.0 ), shininess);                           \n" 
