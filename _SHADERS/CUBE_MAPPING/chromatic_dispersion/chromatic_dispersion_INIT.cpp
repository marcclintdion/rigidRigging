      ...
      "         R                     =  reflect(I, normal_PASS);                                                        \n" 
     
      "         TRed                  =  refract(I, normal_PASS, 1.1);                                                   \n" 
      "         TGreen                =  refract(I, normal_PASS, 1.2);                                                   \n" 
      "         TBlue                 =  refract(I, normal_PASS, 1.3);                                                   \n" 

      "         reflectionFactor      =  0.0 +  attenuation * pow(1.0 + dot(I, normal_PASS), shininess);                 \n"        
      ...
      "         gl_FragColor          =  mix(refractedColor, reflectedColor,  reflectionFactor);                         \n"     
