      ...
      "          vec3 NormalPassed   = normalize(normal);                                                                \n"
      
      "          float noiseScale = 21.8705;                                                                             \n"
      "          float noiseRate  = 0.0598664;                                                                           \n"
     
      "          vec3 noisy;                                                                                             \n"  
      "          noisy.x       = texture2D(Texture1, noiseRate * vPosition.xy *shininess  + attenuation).x;                                 \n"  
    ...
    //"          noisy.y       = texture2D(Texture1, attenuation * vPosition.yx  + 0.5).x;                               \n"  
      ...
      "          vec2 fp       = fract(noiseRate * vPosition.xy + noiseScale * (2.0 * noisy - 1.0));                     \n"
      "          fp           *= (1.0 - fp);                                                                             \n"
//===================================================================================================================================      
      ...
      "         gl_FragColor          =  texture2D(Texture1, varTexcoord.st) * (fp.x + noisy.x) * diffuse;        \n"                       
