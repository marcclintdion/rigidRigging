 glUseProgram(goldenSunset_SHADER);          
          ...
          glUniform4f(UNIFORM_offset_goldenSunset,                     offset[0], 
                                                                       offset[1], 
                                                                       offset[2], 
                                                                       offset[3]);                               
                                                                                                       
          glUniform4f(UNIFORM_tileJump_goldenSunset,                   tileJump_goldenSunset[0],                                
                                                                       tileJump_goldenSunset[1],                                
                                                                       tileJump_goldenSunset[2],                                
                                                                       tileJump_goldenSunset[3]);                               
